...
class AT_form_validation {
	...
	public function __construct($rules = array())
	{
		...
		$this->lang = new form_validation_lang();
	...
	protected function _translate_fieldname($fieldname)
	{
		...
		if (substr($fieldname, 0, 5) == 'lang:')
		{
			...
			if (FALSE === ($fieldname = $this->lang->line($line)))
			{
				return $line;
			}
		}
 ...
 //    }
	...
	{
		return str_replace(array("\x3c\x3f\x70\x68\x70", "\x3c\x3f\x50\x48\x50", "\x3c\x3f", "\x3f\x3e"),  array('&lt;?php', '&lt;?PHP', '&lt;?', '?&gt;'), $str);
	}
...
/*************************************************************************************/
	...
	public function phone($str) {
		return (preg_match("/[^0-9\(\) ,\+-]/", $str) == 1) ? FALSE : TRUE;
	}
	...
	public function is_boolean($str) {
		$mas = array('true', 'false');
		return (in_array($str, $mas)) ? TRUE : FALSE;
	}
	...
	public function get_error( $field ){
		return isset($this->_error_array[$field]) ? $this->_error_array[$field] : '';
	}
}
...
class form_validation_lang {
	...
	private $_lang = array(
		...
		'email_exist' 	=> "The %s field exists. Enter new value.",
